...
namespace ProjectWebAppDBFirst.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public AdminsController(CarnationDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdminId,AdminPassword,Name,Email,Age,Address,DateOfBirth,ContactNumber")] Admin admin)
        {
            if (id != admin.AdminId)
            {
                return NotFound();
